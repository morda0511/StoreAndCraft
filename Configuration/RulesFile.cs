...
namespace StoreAndCraft
{
    ...
    internal static class RulesFile
    {
        ...
        {
            get { return System.IO.Path.Combine(Paths.ConfigPath, "StoreAndCraft.rules.yml"); }
        }
        ...
        public static void LoadOrCreate()
        {
            ...
            {
                Plugin.Log.LogWarning("StoreAndCraft rules failed: " + ex.Message);
            }
        }
        ...
        private static string DefaultText()
        {
            ...
            sb.AppendLine("# StoreAndCraft rules");
            sb.AppendLine("# File: BepInEx/config/StoreAndCraft.rules.yml");
